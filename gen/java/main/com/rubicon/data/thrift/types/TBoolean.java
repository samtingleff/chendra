...
public class TBoolean implements TBase<TBoolean._Fields>, java.io.Serializable, Cloneable, Comparable<TBoolean> {
  private static final TStruct STRUCT_DESC = new TStruct("TBoolean");

  private static final TField VALUE_FIELD_DESC = new TField("value", TType.BOOL, (short)1);
  ...
  static {
    FieldMetaData.addStructMetaDataMap(TBoolean.class, metaDataMap);
  }
