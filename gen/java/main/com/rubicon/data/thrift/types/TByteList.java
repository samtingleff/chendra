...
public class TByteList implements TBase<TByteList._Fields>, java.io.Serializable, Cloneable, Comparable<TByteList> {
  private static final TStruct STRUCT_DESC = new TStruct("TByteList");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(TByteList.class, metaDataMap);
  }
  ...
  public TByteList setValues(List<Byte> values) {
    this.values = values;
    return this;
  }
