...
public class TIntegerList implements TBase<TIntegerList._Fields>, java.io.Serializable, Cloneable, Comparable<TIntegerList> {
  private static final TStruct STRUCT_DESC = new TStruct("TIntegerList");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(TIntegerList.class, metaDataMap);
  }
  ...
  public TIntegerList setValues(List<Integer> values) {
    this.values = values;
    return this;
  }
