...
public class TLongCountableTerm implements org.apache.thrift.TBase<TLongCountableTerm, TLongCountableTerm._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new TLongCountableTermStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TLongCountableTermTupleSchemeFactory());
  }
   ...
   */
  public TLongCountableTerm(TLongCountableTerm other) {
  ...
  public TLongCountableTerm deepCopy() {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TLongCountableTerm)
      return this.equals((TLongCountableTerm)that);
    return false;
  }

  public boolean equals(TLongCountableTerm that) {
    if (that == null)
      return false;
  ...
  public int compareTo(TLongCountableTerm other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    TLongCountableTerm typedOther = (TLongCountableTerm)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TLongCountableTerm(");
    boolean first = true;
  ...
  private static class TLongCountableTermStandardSchemeFactory implements SchemeFactory {
    public TLongCountableTermStandardScheme getScheme() {
      return new TLongCountableTermStandardScheme();
    }
  }

  private static class TLongCountableTermStandardScheme extends StandardScheme<TLongCountableTerm> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TLongCountableTerm struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TLongCountableTerm struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TLongCountableTermTupleSchemeFactory implements SchemeFactory {
    public TLongCountableTermTupleScheme getScheme() {
      return new TLongCountableTermTupleScheme();
    }
  }

  private static class TLongCountableTermTupleScheme extends TupleScheme<TLongCountableTerm> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TLongCountableTerm struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TLongCountableTerm struct) throws org.apache.thrift.TException {
